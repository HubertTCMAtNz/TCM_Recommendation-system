...
for x in test_X:
    ...
    total_s = total_s | set(fang)
    recommend_s = recommend_s | set(ans)
...
hit_s = total_s & recommend_s
print("命中率2：", len(hit_s)/len(total_s))

# tp = len(hit_s)
# fp = topk*j - len(hit_s)

# precision = tp / (tp + fp)
# recall = len(hit_s)/len(total_s)
# print("精确率Precision：", precision)
# print("召回率Recall：", recall)

# F1_score = 2*recall*precision /(recall + precision)
# print("F1-score值：", F1_score)
